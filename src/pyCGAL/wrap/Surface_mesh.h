...
struct Wrapper<CGAL::Surface_mesh<Point>> {
  using cgal_type = CGAL::Surface_mesh<Point>;
  using pybind_class = py::class_<cgal_type>;

  static pybind_class wrap(py::module& module) {
    using Surface_mesh = cgal_type;
    ...
    wutils::wrap_index<Vertex_index, Surface_mesh_index>(module,
                                                         "Vertex_index");
    ...
    pybind_class pyclass = py::class_<Surface_mesh>(module, "Surface_mesh");
    pyclass.def(py::init<>());
    ...
    pyclass.def("degree", py::overload_cast<Vertex_index>(&Surface_mesh::degree,
                                                          py::const_));
    pyclass.def("degree", py::overload_cast<Face_index>(&Surface_mesh::degree,
                                                        py::const_));
